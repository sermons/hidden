...
>>>
+ Mostly for **wives**: same **princp** for husb
...
+ "Sure, can submit to **good** + kind hubby
  + but also to **crooked**?"
...
+ Christ set **example**,
  ...
  + on **our** behalf
+ Submit not only when hubby **good**:
